                  ...
                  child: CustomDropdown(
                    ...
                    onCourseCreate: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CourseCreate(onCourseCreated: handleCourseCreated),
                        ),
                      );
                    },
                  ),
...
class _CustomDropdownState extends State<CustomDropdown> {
  String selectedValue = "Select a Course to add to"; // Initialize with the default value.
  bool isDropdownOpen = false;

  double calculateDropdownHeight() {
    // Calculate the maximum height based on the number of items
    double maxHeight = widget.dropdownItems.length * 50; // Assuming each item is 50 pixels high
      ...
      child: Column(
        ...
        children: [
          ...
          if (isDropdownOpen)
            Container(
              width: 400, // Set a fixed width for the dropdown.
              height: calculateDropdownHeight(), // Set a fixed height for the dropdown.
              decoration: BoxDecoration(
