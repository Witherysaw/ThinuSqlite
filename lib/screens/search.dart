...
import 'colors.dart';
import 'my_courses/courses_main_page.dart';
import 'my_courses/category_details.dart';
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 10.0), // Add some spacing between search bar and button
                    ElevatedButton(
                      onPressed: () {
                      ...
                      child: Text('Search'),
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all<Color>(tuDarkBlue), // Change the button color to orange
                        minimumSize: MaterialStateProperty.all<Size>(Size(60, 45)), // Change the button size
                      ),
                    ),
                  ],
                ),
      ...
      children: categoryList.map((category) {
        return Container(
          ...
          child: ElevatedButton(
            ...
            child: Text(category),
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(tuLightBlue), // Replace with your color
            ),
          ),
        );
      }).toList(),
