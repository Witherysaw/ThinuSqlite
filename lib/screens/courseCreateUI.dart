...
class CourseCreate extends StatefulWidget {
  ...
  const CourseCreate({Key? key, required this.onCourseCreated}) : super(key: key);
...
class _CourseCreateState extends State<CourseCreate> {
  ...
  final TextEditingController _coursesubtitleController = TextEditingController();
  final TextEditingController _coursedescricptionController = TextEditingController();
  final TextEditingController _whatuwilllearnController = TextEditingController();
  final TextEditingController _thiscourseincludesController = TextEditingController();
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white60, // Set the background color of the container
                  border: Border.all(color: tuDarkBlue, width: 1), // Add a border
                    ...
                    child: Column(
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: const InputDecoration(hintText: 'A short Sub-title'),
                        ),
                        const SizedBox(
                          height: 40,
                        ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(hintText: 'Viewers will Learn....'),
                maxLines: 3,
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(hintText: 'This Course Includes....'),
                maxLines: 3,
              ),
              const SizedBox(height: 40),
              Text(
              ...
              TextField(
                ...
                decoration: const InputDecoration(hintText: 'Viewers will Require....'),
                maxLines: 3,
              ),
              const SizedBox(height: 40),
            ],
