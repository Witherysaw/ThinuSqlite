...
class AboutUs extends StatelessWidget {
  ...
  Widget _buildSectionContent(String content) {
    return Padding(
      ...
      child: RichText(
        ...
        text: TextSpan(
          style: const TextStyle(fontSize: 18, color: Colors.black, height: 1), // Adjust line spacing
          children: <TextSpan>[
            TextSpan(
              text: content,
            ),
  ...
  Widget _buildSectionContentDetails(
    int number1, String content1,
    int number2, String content2,
    int number3, String content3,
    int number4, String content4,
  ) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 16), // Increased padding
      child: RichText(
