...
import 'my_courses/card_view_details.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Container(
            width: MediaQuery.of(context).size.width * _questionController.calculateProgress(),
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Colors.blue, Colors.green], // Customize your gradient colors
          ...
          Positioned.fill(
            child: Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("${(_questionController.calculateProgress() * 100).toInt()}%"),
                  Icon(
                    Icons.access_time,
                    color: Colors.black,
                  ),
...
class QuestionCard extends StatelessWidget {
  const QuestionCard({super.key,required this.question, required this.enableNextButton});
          ...
          Column(
            children: [
              ...
              ElevatedButton(
                ...
                child: Text('Exit'),
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all<Color>(tuLightBlue),
                  minimumSize: MaterialStateProperty.all<Size>(Size(200, 45)),// Set your desired color
                ),
              )
            ],
          )
