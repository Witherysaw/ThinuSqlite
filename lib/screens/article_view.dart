...
import 'package:innovationfinale/screens/articles_controller.dart';
import 'colors.dart';
import 'package:intl/intl.dart';
import 'package:readmore/readmore.dart';
import 'package:innovationfinale/screens/premiumbanner.dart';
...
class HomePageState extends State<HomePage> {
  ...
  bool defaultArticlesInserted = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Stack(
        children: [
          Visibility(
            visible: journal['poster'] == "Khant Si Thu",
            child: Positioned(
              top: 10,
              right: 10,
              child: PopupMenuButton(
                ...
                onSelected: (value) {
                  if (value == 'edit') {
                    widget.showFormCallback(journal['id']);
                  } else if (value == 'delete') {
                    widget.deleteItemCallback(journal['id']);
                  }
                },
              ),
            ),
