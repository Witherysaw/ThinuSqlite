...
class QuestionController extends GetxController
  ...
  void incrementProgress() {
    _progress = (_questionNumber.value - 1) / _totalQuestions; // Calculate the progress
  ...
  void checkAns(Question question, int selectedIndex) {
    ...
    isNextButtonEnabled = true; // Ensure that it's set to true when an answer is selected
